...
在 [learning-markdown-1/](http://www.wangs0622.com/2017/08/21/learning-markdown-1/) 中介绍了如何在 markdown 文档中插入超链接，还有另外一种插入的方法，适合批量的插入吧。

可以在文档的底部，或者任意的一处写上下面的语句（下面的三个语句是等效的，没有区别的）：
	
	[id]: http://www.wangs0622.com "我的博客"
	[id]: http://www.wangs0622.com '我的博客'
	[id]: http://www.wangs0622.com (我的博客)

注意： `[id]` 只是一个代号，其中的内容可以随意的更换，不区分大小写。  `"我的博客"` 会在鼠标悬停的时候显示，其中的内容也可以更换。

然后在文档的任意处，需要使用这个超链接的时候，可以写入下面的语句：
...
[id]: http://www.wangs0622.com (我的博客：www.wangs0622.com)
...
上面是显式的使用 [id]，同样可以隐式的调用：

	这是我的[id] [] 欢迎访问~

当第一个中括号里的内容与超链接文本的第一个中括号的内容相同时，才可省略。

**例如：**

这是我的[博客][] 欢迎访问~

[博客]: http://www.wangs0622.com "我的博客"
...
## <font color = purple> 简便形式的超链接 </font>
...
# <font color = red> 插入图片 </font>

类比于超链接的形式，同样可以为图像进行上面的调用：

这是一张图片：
![麦穗图片] [img]

[img]: http://img.ivsky.com/img/tupian/pre/201707/20/chengshu_de_maisui-011.jpg "麦穗"
...
# <font color = red> 使用 emoji 表情 </font>
...
使用这个表情的时候，需要将在两个冒号之间加入表情的描述。

参考：  [emoji][]


[emoji]: https://github.com/guodongxiaren/README/blob/master/emoji.md "emoji 表情大全"

有的 markdown 编辑器并不支持。建议转到 GitHub 上产看效果。
...
在表格中，可以使用其他的 markdown 语法，例如加粗，斜体之类的。在表格中使用 `|` 记得转义，即变为： `\|`。
